...
def main():
    ...
    prizeFile = 'prizeFile.txt'
    edgeFile = 'edgeFile.txt'
    confFile = 'confFile.txt'
    dummyMode = 'all'#'terminals'
    garnet = None
    garnetBeta = '0.01'
    muSquare = False
    ...
    shuffleNum = 10
    seed = 0
    noiseNum = 0 #how many times we want to add noise to edges
    termNum = 0 # how many times we want to apply given values to random nodes
    #pdb.set_trace()
    inputObj = PCSFInput(prizeFile,edgeFile, confFile, dummyMode,
